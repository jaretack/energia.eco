    ...
    <main class="subpage">
        ...
        <article>
            <div class="subpage__header">
                ...
                <header>
                    <h1 class="subpage__header-title">Folie grzewcze</h1>
                    <p class="subpage__header-text">Szukasz niezawodnego i bezproblemowego systemu ogrzewania, którego eksploatacja nic nie kosztuje? Mamy dla Ciebie <strong>najlepsze folie grzewcze</strong>.</p>
                </header>
            ...
            <div class="intro-background">
                <div class="intro intro-1 container box--red-gradient">
                    ...
                    <header class="intro__header">
                        <h2 class="intro__title">Czym są folie grzewcze?</h2>
                    </header>
                    <p class="intro__text">
                        Folie grzewcze w połączeniu z fotowoltaiką, to najlepszy sposób na tanie, darmowe ogrzewanie domu, tańsze od gazu. Są to folie grubości od 0,3 do 0,53 mm, które można montować na ścianie, podłodze i suficie. Działają na podobnej/tej samej zasadzie co/jak słońce, promieniując na przedmioty- jest to ciepło pierwotne. Przedmioty oddają jednostajnie ciepło i jest to ciepło wtórne.
                    </p>
                </div>

                <div class="intro intro-2 container">
                    <header class="intro__header">
                        <h2 class="intro__title">Dla kogo przeznaczone są folie grzewcze?</h2>
                    </header>
                    <p class="intro__text">
                        Każdy kto ceni sobie bezawaryjność, bezobsługowość i praktyczność systemu grzewczego. Dom, mieszkanie, budynki użyteczności publicznej, dogrzewanie konkretnego miejsca pracy- ściana,sufit podłoga- wybór należy do Ciebie, a ogranicza Cię tylko wyobraźnia. Nie ważne czy wymieniasz stare źródło ciepła/ogrzewania domu, czy budujesz nowy obiekt, przestań tracić pieniądze na ogrzewanie i wybierz nasze rozwiązanie.
                    </p>
                </div>
            </div>
